...
class N24TV_Schedule_Entry {
    ...
    static public function loadDay(N24TV_Schedule_Day $Day){
        ...
        $SQL = "SELECT * FROM `" . N24TV_SCHEDULE_TABLE . "` WHERE `date` = '" . $date . "' ORDER BY `start` ASC";
        $r = $db->query($SQL);
    ...
    static public function isFree(DateTime $Start, DateTime $End){
        ...
        $db = N24TV_Schedule_DB::getInstance();
        $SQL = "SELECT COUNT(`start`) AS ECount FROM `" . N24TV_SCHEDULE_TABLE . "` WHERE " . 
    ...
    public function save(){
        ...
        $db = N24TV_Schedule_DB::getInstance();
        $SQL = "INSERT INTO `" . N24TV_SCHEDULE_TABLE . "` (" . 
    ...
    public function delete(){
        $db = N24TV_Schedule_DB::getInstance();
        $SQL = "DELETE FROM `" . N24TV_SCHEDULE_TABLE . "` WHERE `date` = '" . $this->Day->getDate() . "' AND `start` = '" . $this->Start->format('Y-m-d H:i:s') . "'";
        $db->query($SQL);
    }
