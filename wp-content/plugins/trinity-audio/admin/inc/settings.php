...
<?php
  ...
  function trinity_allow_shortcodes() {
    ...
    echo "<input type='text' placeholder='Example: htmltag1, htmltag2' class='custom-input' oninput='trinityCheckFieldDirty(this)' value='$value' name='" . TRINITY_AUDIO_ALLOW_SHORTCODES . "' id='" . TRINITY_AUDIO_ALLOW_SHORTCODES . "' />";

    trinity_bulk_update_dirty_warning();
    trinity_bulk_update_field_notify();
    echo '<p class="description">
            Enter shortcodes that should not be filtered out using comma delimiter, e.g. vc_row,vc_column,su_heading,etc... By default, all shortcodes are filtered out while reading text.
          </p>
          <p class="description">
