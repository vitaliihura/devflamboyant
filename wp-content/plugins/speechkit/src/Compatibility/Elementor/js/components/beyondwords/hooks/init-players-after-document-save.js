...
export class InitPlayersAfterDocumentSave extends $e.modules.hookData.After {
	...
	onRequestSuccess( data, document ) {
		// console.log( 'onRequestSuccess document', document );
		// console.log( 'onRequestSuccess data', data );

		const { beyondwords_project_id, beyondwords_content_id } = data;

		// console.log(
		// 	'onRequestSuccess beyondwords_project_id',
		// 	beyondwords_project_id
		// );

		// console.log(
		// 	'onRequestSuccess beyondwords_content_id',
