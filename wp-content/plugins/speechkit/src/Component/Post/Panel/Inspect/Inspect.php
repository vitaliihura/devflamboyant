...
class Inspect
{
        ...
        <div id="postcustomstuff">
            <table id="inspect-table">
                ...
                <tbody id="inspect-table-list">
                    ...
                    wp_nonce_field('beyondwords_inspect_remove', 'beyondwords_inspect_remove_nonce');
                    ?>
                    <input
                        type="hidden"
                        id="beyondwords_inspect_remove"
                        name="beyondwords_inspect_remove"
                        value="1"
                        disabled
                    />
                </tbody>
    ...
    /**
     * Optionally remove the data when a post is saved.
     *
     * @since 4.0.7
     *
    ...
    public function save($postId)
    {
        ...
        if (
            ! isset($_POST['beyondwords_inspect_remove_nonce']) ||
            ! wp_verify_nonce(
                sanitize_text_field($_POST['beyondwords_inspect_remove_nonce']),
                'beyondwords_inspect_remove'
            )
        ) {
            return $postId;
        }

        if (isset($_POST['beyondwords_inspect_remove'])) {
