...
<tv source-info-url="https://nova24tv.si/" source-info-name="Nova 24TV" generator-info-name="XMLTV/$Id: nova24tv.si@<?=date('c')?> $">

    <channel id="nova24tv">
        <display-name>Nova 24TV</display-name>
    </channel>
